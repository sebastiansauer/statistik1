...
In die gleiche Bresche schlägt "Anscombes Quartett" [@Anscombe_1973].
...
@fig-dino2 zeigt Anscombes Quartet.
...
[Das Ergebnis ist in @fig-mario-scatter2 zu sehen.]{.content-visible when-format="html"}
...
#| echo: false
#| label: fig-lie1
#| fig-cap: "Strecken und Stauchen der Y-Achse, um mit Statistik zu lügen"
#| out-width: "100%"
#| fig-subcap: 
