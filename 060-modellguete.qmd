...
"Dickableibtin extra mild" (c) und rechts das Präparat von Prof. Weiss-Ois' "Pfundafliptan Forte".
...
ohne ihre Form zu verändern, s. @fig-norm-dev.
...
Hat man normalverteilte Variablen, so ist die *Standardabweichung* (engl. standard deviation, SD, $\sigma, s$) eine geeignete Maßeinheit der Streuung,
...
:::callout-important
Je weniger Streuung um den Mittelwert (ca. 47 Euro) herum, desto besser eignet sich der Mittelwert als Modell für die Daten und desto höher ist die Modellgüte. $\square$
:::
...
Man könnte doch die jeweilige Abweichung  in Bezug setzen auf die *mittleren (absoluten) Abweichung* (MAA)!
Ein alternativer,
