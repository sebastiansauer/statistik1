...
Prof. Weiss-Ois präsentiert seine neue Schlankheitspille. Würden Sie Sie einnehmen?
...
::: {.callout-note}
Die Folien zu diesem Kapitel finden Sie [hier](slides/060-modellguete.html) (oder als [PDF](slides/060-modellguete.pdf)).
:::
...
Links ist die Streuung der Schlankheitspille *Dickableibtin*
...
Zentrieren bzw. z-transformieren kann man sich mithilfe des R-Pakets `easystats` verrichten lassen:
