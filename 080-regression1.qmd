...
"Im Modell `lm1` beträgt der Regressionskoeffizient $\beta1 = `r lm1_b1`$. Zwei Studentinnen, deren Lernzeit sich um eine Stunde unterscheidet, unterscheiden sich *laut Modell* um den Wert von $\beta_1$"
