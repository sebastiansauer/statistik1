...
installiert haben,
müssen Sie es noch *starten* bzw. R bereitstellen.
Sie erkennen leicht, ob ein Paket bereit ist, wenn Sie ein Häkchen vor dem
...
Ein *Projekt* in RStudio (s. @fig-rstudio-projekte) ist letztlich ein Ordner, 
...
::: {.content-visible when-format="html"}
{{< downloadthis data/mariokart.csv dname="mariokart.csv" label = "Download CSV" >}} {{< downloadthis data/mariokart.xlsx dname="mariokart.xlsx" label = "Download XLSX" >}}
:::
...
In diesem Datensatz werden die Ergebnisse einer Umfrage zu den Korrelaten von Extraversion beschrieben. Details zu der zugrundeliegenden Studie finden Sie hier: 
...
die Sie updata/installieren, nicht laufen darf.
