...
#| echo: false
#| label: fig-streuung
#| fig-cap: "Ein Modell mit wenig Streuung (links) vs. ein Modell mit viel Streuung (rechts). Die vertikalen grauen Balken kennzeichnen den (absoluten) Abstand von jeweils einem Datenpunkt zum Mittelwert (horizontale orange Linie). Je länger die vertikalen 'Abstandsbalken' insgesamt, desto größer die Streuung."
set.seed(42)
d <-
  tibble(
    id = 1:100,
