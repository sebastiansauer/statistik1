...
Je länger die vertikalen 'Abstandsbalken' insgesamt, desto größer die Streuung.
...
#| fig-cap: "Fehlerbalken in einem einfachen und komplexeren Modell. Links: Fehlerbalken im einfachen Modell: Ein Mittelwert; viel Streuung insgesamt - y ~ 1. Fehlerbalken im komplexen Modell: Zwei Mittelwerte; weniger Streuung in jeder Gruppe. Das erkennt man daran, dass die vertikalen, grauen Abstandsbalken im Schnitt kürzer sind als im einfachen Modell (links). y ~ G"
#| layout-ncol: 2
#| fig-subcap:
#|   - "Einfaches Modell mit viel Fehlerstreuung"
#|   - "Komplexeres Modell mit wenig Fehlerstreuung"
#| out-width: 100%
...
Hat man normalverteilte Variablen, so ist die *Standardabweichung* (engl. standard deviation, SD, $\sigma, s$) eine komfortable Maßeinheit der Streuung,
...
```{r}
#| echo: false
#| fig-cap: "Die Verteilung des Verkaufspreises von Mariokart-Spielen mit MW±SD in roter Farbe"
#| label: fig-var
#| layout-ncol: 2
#| fig-subcap: 
#|   - Dichtediagramm 
