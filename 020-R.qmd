...
:::: {layout="[ 80, 20 ]"}
::: {#first-column}
Ihre R-Muskeln sind gestählt? [💪]{.content-visible when-format="html"} Oder doch noch nicht so ganz ausdefiniert? [😤]{.content-visible when-format="html"} Macht nichts! Trainieren Sie sich mit dem R-Quiz auf der [Datenwerk-Webseite](https://sebastiansauer.github.io/Datenwerk/posts/r-quiz/r-quiz)! $\square$
:::
...
Prüfen Sie Ihr Wissen mit [diesem Quiz](https://sebastiansauer.github.io/Datenwerk/posts/r-quiz/r-quiz)!^[<https://sebastiansauer.github.io/Datenwerk/posts/r-quiz/r-quiz>]
