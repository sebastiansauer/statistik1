...
Bitte stellen Sie sicher, dass Sie R rechtzeitig installiert haben. 
...
bietet uns das Paket `tidyverse` den Komforat, alle die Pakete dieser "Sammlung" auf einmal zu starten. Praktisch.]
...
So hat die Funktion `mean()` z.B. folgende Argumente, s. @list-mean.
...
R-Paket `openintro`; hallo Mario (s. @fig-mario)!
...
### Der Dollar-Operator {#dollar-op}

In @exm-vektoren hatten wir Vektoren definiert.
Solche Vektoren fliegen sozusagen frei in Ihrem `Environment` herum (Schauen Sie dort nach!)
