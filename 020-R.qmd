...
In beiden Fällen wird der "Aufenthaltsort" der Datei durch den *Pfad* (Der Pfad einer Datei gibt an, 
in welchem Ordner und Unterordner (und Unter-Unterordner) die gesuchte Datei liegt. 
Ein Pfad könnte z.B. so aussehen: "/Users/sebastiansaueruser/github-repos/statistik1/".) und den Namen der Datei definiert.
