...
Meister Yoda rät: Lesen Sie die folgenden Hinweise, s. @fig-yoda [aimgflip_yoda_2024].
...
qr <- qrcode::qr_code("https://datenwerk.netlify.app/")
plot(qr)
```
:::
::::
...
:::: {layout="[ 80, 20 ]"}
::: {#first-column}
Schauen Sie sich mal den YouTube-Kanal  `@sebastiansauerstatistics` an und dort die [Playlist "R"](https://www.youtube.com/playlist?list=PLRR4REmBgpIEaIyeNBgNGPgmhQJ_T1y8_).
