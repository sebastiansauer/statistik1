...
![Temperatur (Grad Celcius) im Veraluf der Jahre](img/fig-wetter-anim-1.gif)

![Niederschlage (mm) im Veraluf der Jahre](img/fig-wetter-anim-2.gif)
...
Am Anfang kann es nervig sein, dass das Bundesland, 
...
so können sich die Modellkoeffizienten dramatisch verändern (auch das Vorzeichen ändern^[das nennt man dann *Simpsons Paradox*]),
...
2. Bei Prädiktoren mit starken (absolunte) Effekten kann es Sinn machen, ihre Interaktionseffekte auch mit in das Modell aufzunehmen
...
Die Lehrerin müsste also rufen: "Schorsch Müller (oder Meier), komm her!".
...
1. Berechnen Sie Ihr Modell in einem Teil Ihres Datensatzes (dem sog. *Validation-Sample*).
2. Prüfen Sie die Modellügte in einem zweiten Teil Ihres Datensatzes (dem sog. *Assessment-Sample*)
