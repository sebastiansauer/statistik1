...
Laut [dieser Quelle](https://en.wikipedia.org/wiki/Average_human_height_by_country) beträgt der Wert der mittleren Größe deutscher Frauen etwa 1,66m, also 14cm weniger als bei Männern.
...
Bezeichnen wir die Abweichung - auch als "Fehler", "Rest" oder "Residuum" bezeichnet - der $i$-ten Person mit $\textcolor{#009E73}{\text{e}_i}$ (*e* wie engl. *error*, "Fehler) und die $i$-te Note mit $x_i$, so können wir festhalten:

$$\textcolor{#E69F00}{\text{y}_i} = 
  \textcolor{#56B4E9}{\bar{x}} + 
  \textcolor{#009E73}{\text{e}_i}$$

Anders ausgedrückt:


$$\textcolor{#E69F00}{\text{Daten}} =     \textcolor{#56B4E9}{\text{Modell}} + 
\textcolor{#009E73}{\text{Rest}}$$
...
$$\textcolor{#E69F00}{\hat{y}} \sim \textcolor{#56B4E9}{\text{m}}$$ {#eq-mean-mod}

Lies: "Der Modellwert $\textcolor{#E69F00}{\hat{y}}$ ist eine Funktion des Modells $\textcolor{#56B4E9}{\text{m}}$". 
Der Kringel "~"^[Das "Kringel" oder die "Welle" "~" nennt man auch "Tilde"] soll also hier heißen "... ist eine Funktion von ...".

Mit $\textcolor{#E69F00}{\hat{y}}$ ist die vorhergesagte bzw. die zu erklärende Variable^[AV, Output-Variable, Zielvariable] gemeint.
Das "Dach"  über dem $\textcolor{#E69F00}{\text{y}}$ bedeutet "vorhergesagter Y-Wert" oder "Y-Wert laut dem Modell".
Der tatsächliche, beobachtete Wert $\textcolor{#E69F00}{\text{y}}$ setzt sich zusammen aus dem Modellwert $\textcolor{#56B4E9}{\text{m}}$ plus einem Fehler $\textcolor{#009E73}{\text{e}}$.

$$\textcolor{#E69F00}{\text{y}}  = \textcolor{#56B4E9}{\text{m}} + \textcolor{#009E73}{\text{e}}$$

Anstelle von  $\textcolor{#56B4E9}{\text{m}}$ schreibt man auch $\textcolor{#E69F00}{\hat{y}}$ ("y-Dach"). 
...
$$\textcolor{#E69F00}{y}  = \textcolor{#56B4E9}{\bar{x}} + \textcolor{#009E73}{e}$$


Die Zielvariable $\textcolor{#E69F00}{\text{y}}$ wird also durch ihren eigenen Mittelwert erklärt, außer gehen wir von einem Fehler $e$ in unseren Modellvorhersagen aus. Nobody is perfect.
In späteren Kapiteln werden wir andere Variablen heranziehen, um die Zielvariable zu erklären.
Würden wir z.B. sagen wollen, dass wir $\textcolor{#E69F00}{\text{y}}$ als Funktion einer Variable $X$ erklären,
so würden wir schreiben:

$$\textcolor{#E69F00}{\bar{y}} \sim \textcolor{#56B4E9}{\text{x}} $$
\textcolor{#E69F00}{\bar{y}}
Da wir im Moment aber keine andere Variablen bemühen, um $\textcolor{#E69F00}{\text{y}}$ zu erklären schreibt man auch:

$$\textcolor{#E69F00}{\bar{y}} \sim 1$$

Diese Schreibweise sieht verwirrend aus. 
Die $1$ soll aber einfach zeigen, dass wir keine andere Variable zur Erklärung von$\textcolor{#E69F00}{\text{y}}$ verwenden, 
...
:::{#exr-mw-wealth1}
Was schätzen Sie, wie hoch das mittlere Vermögen des Haushalte in Deutschland in etwa ist?^[Quelle:  [WSI](https://www.wsi.de/en/how-is-wealth-distributed-in-germany-14401.htm), Abruf 2023-04-19])
...
Verschiedene Arten von Quantilen animiniert.
...
Die dahinter stehende *Forschungsfrage* könnte lauten:
...
>    Körpergröße $\textcolor{#E69F00}{\text{y}}$ ist eine Funktion des Geschlechts $G$.
