...
![Immer schön Ordnung halten... Image credit: Allision Horst, https://github.com/allisonhorst/stats-illustrations, CC-BY](img/tidydata_3.jpg){#fig-tidy3 width="75%"}
...
[Quelle: Garrick Aden-Buie, 2018, CC0-1.0 license, <https://www.garrickadenbuie.com/project/tidyexplain/>, CC-BY-SA]{.small}
...
Sie brauchen nur experimentierfreudige Partner (Kleingruppen mit 2-4 Personen), eine faire Münze und dann kann's los gehen! [Klicken Sie hier, um mit dem Experiment zu starten](https://docs.google.com/forms/d/e/1FAIpQLSeAwqNyZtyQwttq5JrQdQ2AO7w5vzcVDXjiejKnyFNxiWtEag/viewform?usp=sf_link).^[<https://forms.gle/q4F1DrbgfhLAiH1s5>]
...
Sind Sie süchtig nach Ihrem Handy? Lassen Sie uns eine kleine Studie dazu live im Hörsaal durchführen. Füllen Sie [diese Umfrage](https://forms.gle/PP8yb6Ubqq3JU78F9) zum Thema Smartphonse-Sucht aus (anonym und kein Muss).^[<https://forms.gle/PP8yb6Ubqq3JU78F9>] Wir werten die Daten später zusammen aus. $\square$
