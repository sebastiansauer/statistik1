...
@fig-regrtex skizziert die Elemente einer Regression.^[Bildquelle: Basierend auf einem Diagramm von Henri Menke, <https://texample.net/tikz/examples/linear-regression/>]
...
Ein Klassiker mit viel Aha-Potenzial ist @cohen2003.
