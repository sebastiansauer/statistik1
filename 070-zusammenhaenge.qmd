...
Der Korrelationskoeffizient $r$ ist definiert als das mittlere Produkt der z-Wert-Paare: $r_{xy}=\frac{1}{n}\sum_{i=1}^n z_{x_i} z_{y_i}$, vgl @cohen_applied_2003. $\square$
:::
...
1. [nasa03](https://datenwerk.netlify.app/posts/nasa03/nasa03.html)
