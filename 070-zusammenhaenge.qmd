...
Einer der beiden Datensätze sei mit  Einschränkung des Ranges und einer ohne.
...
Wir schränken dann den Wertebereich von $X$ ein auf, sagen wir, auf $[-0.5, .5]$ (Datensatz `d_filtered`), s. @lst-corr-range.
