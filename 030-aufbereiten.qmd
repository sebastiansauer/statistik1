...
zunächst, indem Sie einfach den R-Code kopieren und selber ausführen. $\square$
:::
...
Erzielen Auktionen von *neuen* Spielen und zwar *mit* Photo einen höheren Preis als die übrigen Auktionen?
...
Vertiefte Informationen zum Auswählen von Spalten mit `select` finden sich [hier](https://tidyr.tidyverse.org/reference/tidyr_tidy_select.html).^[<https://tidyr.tidyverse.org/reference/tidyr_tidy_select.html>]
