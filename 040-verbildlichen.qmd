...
Wer an Vertiefung interessiert ist, f
indet bei data-to-vis einen Überblick über verschiedene Typen an Diagrammen, 
sogar in Form einer systematischen Nomenklatur: <https://www.data-to-viz.com/>.]
...
s. @fig-norm-perc.^[Quelle: Ainali -- Own work, CC BY-SA 3.0, <https://commons.wikimedia.org/w/index.php?curid=3141713>]
...
@fig-cors2 hat die gleiche Aussage, 
ist aber plakativer, 
...
dass ein *negativer* Korrelationskoeffizient mit einer *absinkenden* Trendgerade^[synonym: Regressionsgerade] 
(blaue Linie) einhergeht.
