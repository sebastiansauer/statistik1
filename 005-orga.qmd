...
dass regelmäßiges Üben und Dranbleiben mit Erfolg einher geht [@sauer2017a].
...
:::: {layout="[ 80, 20 ]"}
::: {#first-column}
Motivation nötig? Dann schauen Sie sich das Video mit einer [Ansprache zur Motivation](https://youtu.be/jtNlzpcPr5Y) an.
:::
...
In den meisten Kapiteln dieses Buches analysieren wir Datensätze;
...
Dort gibt es auch einen Überblick über [weitere Bücher des Autors zum Thema Datenanalyse](https://sebastiansauer-academic.netlify.app/#ebooks).^[<https://sebastiansauer-academic.netlify.app/#ebooks>]
