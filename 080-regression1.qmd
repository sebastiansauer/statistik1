...
noten2 %>% 
  ...
  geom_abline(slope = coef(lm1)[2], intercept = coef(lm1)[1], color = okabeito_colors()[1], size = 1.5) +
  theme_minimal() +
...
ggplot(d1, aes(x1, y1)) + 
  geom_point() +
  geom_smooth(method = "lm", se = TRUE, color = okabeito_colors()[1]) +
