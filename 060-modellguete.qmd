...
Also führt Fritz seine Kuh durch den Fluss, leider kam die Kuh nicht am anderen Ufer an, s. @fig-fluss-tief.
...
#|   - "Fehlerbalken im komplexen Modell: Zwei Mittelwerte; wenig Streuung in jeder Gruppe"
...
ggplot(d) +
  ...
  annotate("label", x = 1, y = 0, label = "Mittelwert") +
  theme_minimal()
```
...
Allen Downey [-@downey_probably_2024] stellt in seinem vergnüglich zu lesenden Buch eine kurzweilige Einführung in die Statistik vor;
