...
"Im Schnitt haben die Studis bei der letzten Klausur ungefähr `r mean(noten2$y)`  der Punkte erzielt. 
...
In dem Fall wird der Mittelwert, `r mean(noten2$y)`, als Gerade verwendet.
...
Wir sagen für jede Beobachtung einen Wert von `r mean(noten2$y)` vorher.
...
als lineare Funktion von unabhängigen Variablen, \color{xcol}{x}, an, plus einem Fehlerterm, \color{errorcol}{e} bzw. \color{errorcol}{\epsilon}, s. @eq-linear-model.
...
#| echo: false
#| fig-cap: "Vorhersagefehler als Abweichungsbalken: Beim Geradenmodell, links, sind die Vorhersagefehler (Abweichungsbalken) kleiner (kürzer) als beim Punktmodell, rechts."
#| label: fig-resid
#| layout-ncol: 2
#| fig-subcap: 
#|   - Geradenmodell (lm1)
...
"Im Modell `lm1` beträgt der Regressionskoeffizient `beta1` $`r lm1_b1`$. Zwei Studenti, deren Lernzeit sich um eine Stunde unterscheidet, unterscheiden sich *laut Modell* um den Wert von beta1."
...
finden Sie [im Datenwerk](https://sebastiansauer.github.io/Datenwerk/posts/ames-kaggle1/ames-kaggle1.html).^[<https://sebastiansauer.github.io/Datenwerk/posts/ames-kaggle1/ames-kaggle1.html>]
...
Schauen Sie sich die Aufgaben beim [Datenwerk](https://sebastiansauer.github.io/Datenwerk/) an, vor allem die Tags [regression](https://sebastiansauer.github.io/Datenwerk/#category=regression) und [lm](https://sebastiansauer.github.io/Datenwerk/#category=lm).
...
Beachten Sie die [Hinweise zu den Aufgaben](https://sebastiansauer.github.io/Datenwerk/hinweise).^[<https://sebastiansauer.github.io/Datenwerk/hinweise>]
