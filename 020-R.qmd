...
Eine gute Nachricht: Wenn R etwas von `WARNING` (bzw. Warnung) sagt, können Sie das zumeist ignorieren. Eine Warnung ist kein Fehler (`ERROR`) und meistens nicht gravierend oder nicht dringend.
