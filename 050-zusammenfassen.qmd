...
p1 <- ggplot(mariokart2) +
  ...
  annotate("label", x = 0, y = 47, label = paste0("MW: 47"))
...
:::{.callout-tip}
Schauen Sie sich auch mal auf [datenwerk.netlify.app](https://datenwerk.netlify.app) die Aufgaben zu z.B. dem Tag [EDA](https://sebastiansauer.github.io/Datenwerk/#category=eda) an. $\square$
:::
