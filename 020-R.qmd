...
:::{#fig-rlove layout="[ 40, 20, 40 ]"}


![R](img/rstudio-logo-small.png){width=40%}

![und](img/sparkling_heart.png){width=40%}

![RStudio](img/rlogo.png){width=70%}
...
![RStudio-Projekte: nützlich [@horst_statistics_2024]](img/cracked_setwd.png){#fig-setwd}
:::
::::
:::::
...
So updaten Sie Ihre R-Pakete: Klicken Sie im Reiter `Packages` (in RStudio) und dort auf den Button `Update`. 
...
die Sie updaten/installieren, nicht laufen darf.
