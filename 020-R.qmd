...
Wenn Sie Quarto nutzen möchten, müssen Sie es zunächst installieren, d.h. [herunterladen](https://quarto.org/docs/get-started/). Dann können Sie in RStudio Quarto-Dateien erstellen.

Ein neues Quarto-Dokument können Sie erstellen mit Klick auf *File > New File > Quarto Document ...*.


[Dieses Video](https://youtu.be/_f3latmOhew) gibt Ihnen Einstieg in Quarto.
...
{{< downloadthis daten/mariokart.csv dname ="mariokart.csv" >}}
...
Irgendwann werden Ihr R, RStudio und Ihre R-Pakete veraltet sind.
