...
Der Korrelationskoeffizient $r$ ist definiert als das mittlere Produkt der z-Wert-Paare: $r_{xy}=\frac{1}{n}\sum_{i=1}^n z_{x_i} z_{y_i}$. $\square$
:::
...
Wie man sieht, liegt in diesen Beispielen kein linearer Zusammenhang vor ($r=0$), obwohl ein starker nicht-lineare Zusammhang bestehte.
