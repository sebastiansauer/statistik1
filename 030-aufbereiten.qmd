...
Die Funktion `arrange()` macht es uns ziemlich einfach:
...
Es muss ein höherer Wert rauskommen, findet dis Analysti. Der mittlere Verkaufspreis (im Datensatz `mariokart`) 
liegt bei 50 Euro. 
