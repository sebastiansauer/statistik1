...
```{r}
mariokart_neu <- filter(mariokart, stock_Foto == "yes")
```
...
mit anderen Worten, Auktionen (Beobachtungen) bei denen gilt: `stock_Foto == TRUE`. $\square$
:::
