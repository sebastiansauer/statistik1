...
{{< downloadthis daten/wetter.csv dname = "wetter" >}}
...
In einer Studie mit viel Medienresonanz untersuchten @youyou_computer-based_2015, wie gut Persönlichkeitszüge durch Facebook-Daten (Likes etc.) vorhergesagt werden können.
