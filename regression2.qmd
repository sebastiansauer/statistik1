...
In @tbl-wetter und @fig-wetter-anim kann man sich die Daten en Detail anschauen.


```{r}
#| echo: false
#| fig-cap: fig-wetter-anim
#| label: Veränderung der Temperatur und Niederschlag (10-Jahres-Mittel) in Deutschland
#| eval: true
#| layout-ncol: 2
#| fig-subcap: 
#|   - Temperatur (Grad Celcius)
#|   - Niederschlag (mm pro Quadratmeter)
...
Die Veränderung der monatlichen Temperatur (10-Jahres-Mittel) ist in @fig-temp-monat dargestellt.
