...
In der Statistik wird folgende Nomenklatur bevorzugt: $f(x)=\hat{y} = \color{red}{b_0} + \color{blue}{b_1} \color{#F5C710}{x}$ oder $\hat{y}  = \color{red}{\beta_0} + \color{blue}{\beta_1} \color{#F5C710}{x}$ .^[Die Nomenklatur mit $b_0, b_1$ hat den Vorteil, dass man das Modell einfach erweitern kann: $b_2, b_3, ...$. Anstelle von $b$ liest man auch oft $\beta$. Griechische Buchstaben werden meist verwendet, um zu zeigen, dass man an einer Aussage über eine Population, nicht nur über eine Stichprobe, machen möchte.]

Das "Dach" über y, $\hat{y}$, drückt aus, dass es sich den den geschätzten, bzw. vom Modell vorhergesagten (modellierten) Wert für $y$ handelt, nicht das tatsächliche (empirische) $y$. $\square$
:::
...
$$\begin{aligned}
\textcolor{#E69F00}{y} &= f(\textcolor{#56B4E9}{x}) + \textcolor{#009E73}{\epsilon} \\
\textcolor{#E69F00}{y_i} &= \color{red}{\beta_0} + \color{blue}{\beta_1} \cdot \textcolor{#56B4E9}{x_i} + \textcolor{#009E73}{\epsilon_i} \square
\end{aligned}$$

Mit:

- $\color{red}{\beta_0}$: geschätzter y-Achsenabschnitt laut Modell
- $\color{blue}{\beta_1}$: geschätzte Steigung laut Modell
- $\textcolor{#009E73}{\epsilon}$: Fehler des Modells
...
$$\textcolor{#E69F00}{\hat{y}} \sim \textcolor{#56B4E9}{\text{m}}$$ {#eq-mod1}

Lies: "Laut meinem Modell ist mein (geschätztes) $\textcolor{#E69F00}{\hat{y}} irgendeine Funktion von $$\textcolor{#56B4E9}{\text{m}}$".

Wir erinnern uns, dass $\textcolor{#E69F00}{Y}$ die $\textcolor{#E69F00}{AV}$ und $\textcolor{#56B4E9}{X}$ die $\textcolor{#56B4E9}{UV}$ ist:

$$\textcolor{#E69F00}{AV} \sim \textcolor{#56B4E9}{UV}$$ {#eq-mod1}
...
$$\text{min}\sum_i \textcolor{#009E73}{e_i}^2$${#eq-min}
...
Im gegenteiligen Extremfall von $R^2=0$ ist die Vorhersage genauso gut, wie wenn man für jedes $y$ den Mittelwert, $\textcolor{#E69F00}{\bar{y}}$, vorhersagen würde. 
