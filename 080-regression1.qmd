...
Das einfache lineare Modell nimmt den Wert einer [abhängigen metrischen Variablen]{.orange} als lineare Funktion einer [unabhängigen Variablen]{.lightblue} an, plus einem [Fehlerterm]{.green}:
...
:::{#callout-caution}
Unterschiede zwischen Korrelation dürfen nicht linear interpretiert werden. $\square$
:::
