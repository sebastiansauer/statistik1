...
::: {.callout-note}
Die Folien zu diesem Kapitel finden Sie [hier](slides/050-zusammenfassen.html) (oder als [PDF](slides/050-zusammenfassen.pdf)).
:::
...
der das Viertel mit den kleinsten Wert vom Rest der Daten trennt das *erste Quartil* (Q1, 25$\,$%).
...
2. Schneide die oberen 10% ab (entferne sie).
...
>    [🧑‍🏫]{.content-visible when-format="html"}[\emoji{teacher}]{.content-visible when-format="pdf"} Frag doch mal ChatGPT oder einen anderen Chatbot -- dort bekommt man auch R-Code ausgegeben.
