...
In diesem Kapitel benötigen Sie üblichen R-Pakete (`tidyverse`, `easystats`) und Daten (`mariokart`).
...
![Der Mittelwert als "typisches Element" eines Vektors](img/mw-modell-crop2.png){#fig-mw2 width="50%"}
...
Wi man in @eq-summenull sehen kann: Die Summe der Abweichungen vom Mittelwert ist Null.
...
#| echo: false
#| label: fig-mario-qs1
#| fig-cap: "Q1, Q2 und Q3 für das Schlussgebot (nur Spiele für weniger als 100 Euro) in einem Dichediagramm"
...
<!-- Alternativ zu @lst-mario-lage ließe sich auch der Befehl `describe_distribution()` aus `{easystats}` verwenden:  -->
...
![Die deskriptive fasst eine Spalte zu einer einzelnen Zahl zusammen.](img/desk-stats-zsmnfassen-crop.png){#fig-desk width=20%}
