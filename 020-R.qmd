...
>    [🧑‍🎓]{.content-visible when-format="html"}[\emoji{student}]{.content-visible when-format="pdf"} Wie ist es um unsere Wissenschaft, Psychologie, bestellt? Haben die Befunde Hand und Fuß?
...
:::: {.column width="20%"}
::: {.content-visible when-format="pdf"}
\centering{![](img/sparkling_heart.png){width="40%"}} 
:::
::::
...
>    [🧑‍🎓]{.content-visible when-format="html"}[\emoji{student}]{.content-visible when-format="pdf"} Ja, aber welche R-Pakete "soll" ich denn installieren, welche brauch ich denn?
...
>   [🤖]{.content-visible when-format="html"}[\emoji{robot}]{.content-visible when-format="pdf"} Achtung, lieber Herr und Gebieter, du hast nicht mehr alle Latten am Zaun, will sagen, alle Daten im Vektor!
...
>   [🤖]{.content-visible when-format="html"}[\emoji{robot}]{.content-visible when-format="pdf"} Wie wäre es mit "nebulöse Anomalie" oder "nix-checkender Angeber" oder "nölender Automat".

>   [👩‍🎓]{.content-visible when-format="html"}[\emoji{woman-student}]{.content-visible when-format="pdf"} Hm...
