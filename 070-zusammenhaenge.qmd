...
2. Fragen Sie diese Person nach je zwei Variablen, die wie folgt zusammenhängen:
...
::: {.callout-note}
Die Folien zu diesem Kapitel finden Sie [hier](slides/070-zusammenhaenge.html) (oder als [PDF](slides/070-zusammenhaenge.pdf)).
:::
...
Wenn die Summe der Abweichungsrechtecke Null ist, 
...
und  Babys ist (die  Gegebenheiten bei hoher Naturbelassenheit begünstigt eine höhere Zahl von Kindern pro Frau).
...
Tipp: Nutzen Sie die Übersetzungsfunktion Ihres Browsers, wenn Sie das Buch nicht in Englisch lesen wollen.
