...
toni_punkte <- predict(lm_toni_b1, newdata = data.frame(x=42))
```
...
R-Quadrat, $r$ (als Korrelation von tatsächlichem $y$ und vorhergesagten $\hat{y}$), MSE, RMSE, MAE, …
...
Leider ist es häufig so, dass UV mit Wert 0 in der Praxis nicht realistisch sind, 
