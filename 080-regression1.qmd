...
"Ich kann den Verkaufspreis von Mariokart-Spielen im Schnitt auf `r round(mae(lm3),0)` Dollar genau vorhersagen!".
Hört sich gut an.
...
Ein Klassiker mit viel Aha-Potenzial ist @cohen2013.
