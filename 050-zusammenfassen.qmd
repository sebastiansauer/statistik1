...
In diesem Kapitel benötigen Sie üblichen R-Pakete (`tidyverse`, `easystats`) und Daten (`mariokart`),  s. @sec-import-mariokart.
...
sowie die Abweichungen Residuen, Fehler; häufig mit $e$ wie *error* bezeichnet) der einzelnen Noten vom Mittelwert eingezeichnet. $\square$
:::
...
Wie man in @eq-summenull sehen kann: Die Summe der Abweichungen vom Mittelwert ist Null.
...
Gruppierte Lagemaße lassen sich in R z.B. so berechnen, s. @lst-mario-lage-gruppiert und @tbl-group-mean, also ähnlich wie in @lst-mario-lage.
