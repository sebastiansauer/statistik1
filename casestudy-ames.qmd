...
die Korrelation aller Prädiktoren mit der abhängigen Variablen^[die vorherzusagende Variable, auch Ziel- oder Outcome-Variable genannt] zu berechnen.
...
```
1. Nimm die Tabelle `m1_smb`
2. Filter so, dass du nur Zeilen hast, für die gilt, "hier ist ein NA in der Spalte `SalePrice`
