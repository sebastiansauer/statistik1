...
Prof. Weiss-Ois hat eine Erfindung gemacht, eine Schlankheitspille[💊]{.content-visible when-format="html"}.^[Bilduelle: Icon unter Flaticon licence, Autor: iconixar, <https://www.flaticon.com/free-icons/professor>]
...
Der IQR beträgt dann: $IQR = Q3-Q1 = 1.75m - 1.65m = 0.10m$, d.h. 10 cm.$\square$
:::
...
Sind Sie händysüchtig? Das ist die Forschungsfrage [dieser Umfrage](https://docs.google.com/forms/d/e/1FAIpQLSfM6oDLHX4_lqWq-bXw39drTkdGAvecE6ow2HIKoxdrVygp2A/viewform). Nehmen Sie ggf. an dieser Umfrage teil (sie ist anonym und dauert drei Minuten).
