...
:::{#def-statistik}
### Grundlegende Aufgaben Statistik
Zu den grundlegenden Aufgaben der Statistik gehört, a) Werte zu ihrer zentralen Tendenz zusammenzufassen, b) die Unterschiedlichkeit dieser Werte zu bemessen
und c) die Ungewissheit unserer Schlüsse zu bestimmen [@poldrack_statistical_2023; @kaplan_statistical_2009]. $\square$
:::
...
Betrachten wir die drei Bestimmungsstücke einer Definition von Statistik genauer: 1. Zur zentralen Tendenz zusammenfassen, 2. Unterschiedlichkeit quantifizieren und 3. Ungewissheit beschreiben.


### Zur zentralen Tendenz zusammenfassen

@fig-zsmnfassen verdeutlicht das Prinzip des Zusammenfassens von Daten zur zentralen Tendenz.
Einfach ausgedrückt:
Eine Zahlenreihe wird zu einer einzelnen Zahl "zusammengedampft". Diese Zahl soll "typisch" sein für die zugrundeliegende Zahlenreihe.
Eine einzelne Zahl ist wesentlich besser zu verstehen als eine große Anzahl von Zahlen. Bei vielen Zahlen würde man den Überblick verlieren.
...
:::{#exm-schraube}
### Typischer Durchmesser von Schrauben
Ein Betrieb stellt eine bestimmte Art von Schrauben her, die einen mittleren Durchmesser von 5,0 mm vorweisen sollen.
Um zu prüfen, ob die Schrauben dieser Anforderung genügen, werden regelmäßig Stichproben gezogen und der Durchmesser jeweils bestimmt. 
Die Messwerte werden dann zum Mittelwert (arithmetisches Mittel) zusammengefasst. $\square$
:::
...
:::{#exm-ungewiss1}
Anna hat eine Statistik-Klausur geschrieben. Sie hat keine Ahnung, ob sie bestehen wird. Berta hingegen ist sich sehr sicher, dass sie bestanden hat. 
Die beiden Studentinnen unterscheiden sich also stark in der Ungewissheit hinsichtlich ihrer Einschätzung zum Klausurerfolg, s. @fig-ungewiss-anna-berta. $\square$
:::
