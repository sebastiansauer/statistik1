...
```{r}
#| eval: false
mariokart_train <- read_csv("data/mariokart_train.csv")
```
...
```{r}
mariokart_train <- read_csv("https://raw.githubusercontent.com/sebastiansauer/statistik1/main/data/mariokart_train.csv")
```

Dann importieren wir auf gleiche Weise Test-Sample in R:

```{r}
mariokart_test <- read_csv("https://raw.githubusercontent.com/sebastiansauer/statistik1/main/data/mariokart_test.csv")
```
...
mariokart_train <- read_csv(mariokart_train_path)
```
...
mariokart_test <- read_csv(mariokart_test_path)
```
...
penguins <- read_csv(penguins_path)
```
:::
