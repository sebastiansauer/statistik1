...
also eine *Spalte* zu einer (einzelnen) *Zahl* zusammen, s. @fig-desk-summ.


![`summarise` fasst eine Spalte (oder mehrere) zu einer einzelnen Zahl zusammen](img/desk-stats-zsmnfassen-crop.png){#fig-desk-summ width=25%}
