...
dass die Gesamtlänge der "nach oben ragenden Balken" identisch ist zur Gesamtlänge der nach "unten ragenden Balken", vgl. @fig-wippe.
...
:::{.callout-note}
1 Million hat 6 Nullernhinter der führenden Eins: 1000000.
...
Sie fassen eine Verteilung zu einem einzelnen Wert zusammen und geben uns ein "Bild" der Daten, machen sie uns verständlich -- sie sind uns also ein Modell.
...
Das Vorgehen und die zugrundeliegenden Entscheidungen offenlegen.
