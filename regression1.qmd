...
:::{#def-r2}
### R-Quadrat
R-Quadrat eines Modells $m$ ist definiert als die Verringerung der Streuung, wenn man das Modell $m$ mit dem Nullmodell $m_0$ vergleicht: $R^2 =1-  \frac{\text{MSE}_{m}}{\text{MSE}_{m0}}$. R-Quadrat ist ein Maß der *Modellgüte*: Je größer, desto besser die Vorhersage. 
...
Im gegenteiligen Extremfall von $R^2=0$ ist die Vorhersage genauso gut, wie wenn man für jedes $y_$ den Mittelwert, $\bar{y}$, vorhersagen würde. 
