...
Die Spalten mit den *t*- und *p*-Werten in der Ausgabe ignorieren wir einfach. 
Einatmen, ausatmen.
...
und das zugehörige Schätzbereich (Konfidenzintervall) 
...
:::{.callout-important}
Interpretiere  Modellkoeffizienten nur kausal, wenn du Kausalmodell hast. $\square$
:::
...
So können sich die Modellkoeffizienten dramatisch verändern 
(sogar das Vorzeichen kann wechseln; das nennt man dann *Simpsons Paradox*),
...
z.B. "Dort wo es viele Störche gibt, gibt es auch viele Babies".^[Das Störche-Babys-Beispiel passt auch zu @fig-confounder.]
...
Wenn Sie dran bleiben, wird die Statistik Ihr bester Freund [@imgflip2024].
