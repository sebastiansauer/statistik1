...
Eine allgegenwärtige Tatsache ist, dass die Dinge der Welt sich unterscheiden, g
enauer gesagt, dass Exemplare einer Gattung sich unterscheiden. 
...
tibble(x = c(1,2,5), Liebling = c("🥩", "🍝", "🍕")) %>% 
  ggplot()+
  aes(x=x) +
  geom_label(aes(label = Liebling), y = 1, size = 7) +
  theme_minimal() +
