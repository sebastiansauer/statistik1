...
Langsam fühlen Sie sich als Datenchecker ... [🥷 🦹‍♀]{.conten-visible when-format="html"}] $\square$
:::
...
:::{.callout-caution}
Ein beliebter Fehler ist es übrigens, nicht die richtige Zahl an schließenden Klammern hinzuschreiben, z.B. `fasse_zusammen(gruppiere(wähle_spalten(filter_zeilen(meine_daten))))` FALSCHE ZAHL AN KLAMMERN. $\square$
:::
...
Im Datenwerk finden Sie dazu Übungen, etwa [mutate03](https://datenwerk.netlify.app/posts/mutate03/mutate03.html)
