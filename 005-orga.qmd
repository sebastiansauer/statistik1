...
:::: {layout="[ 80, 20 ]"}
::: {#first-column}
Auf der Webseite ["Datenwerk"](https://sebastiansauer.github.io/Datenwerk/) wird eine *große Zahl an Aufgaben *bereitgestellt. Am Ende jedes Kapitels dieses Buchs finden Sie eine Auswahl an Aufgabennamen, die Sie im Datenwerk lösen können. Beachten Sie die [Hinweise zu den Aufgaben](https://sebastiansauer.github.io/Datenwerk/hinweise).
:::
