...
Verteilungen unterscheiden sich z.B. einerseits in ihrem "typischen" oder "mittleren" Wert^[vgl. @sec-lage] und anderseits in ihrer Streuung^[vgl. ]
...
Wenn sich eine Variable als Summe mehrerer, unabhängiger, etwa gleich starker Summanden, dann kann man erwarten, dass sich diese Variable normalverteilt.
...
@fig-normal-interactive zeigt  interaktive Beispiele für Normalverteilung. Wählen Sie einfach Mittelwert ($\mu$) und Streuung ($\sigma$). [Quelle](https://observablehq.com/@mcmcclur/the-normal-model)
