...
![Life is a roller-coaster. You just have to ride it. Image credit: Allison Horst](img/r_rollercoaster.png){#fig-roller width="80%"}
...
Als Beispiel betrachten wir den Datensatz `extra` aus dem R-Paket `{pradadata}`^[<https://github.com/sebastiansauer/pradadata>]. In diesem Datensatz werden die Ergebnisse einer Umfrage zu den Korrelaten von Extraversion beschrieben.
