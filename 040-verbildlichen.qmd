...
Möchten wir den Zusammenhang von vielen Variablen, z.B. mehr als mher, verstehen,
...
Wie man sieht, besteht so ein Diagramm aus *Balken*, daher heißt es *Balkendiagramm* (synonym: Säulendiagramm).
...
nd wird daher hier besonders uhervorgehoben.
...
Lässt sich die Beziehung zwischen zwei Variablen mit einer Geraden visualisieren,
...
so erkennt man, 
dass R `wheels` als stetige Zahl betrachtet und nicht in ganze Zahlen gruppiert. Vielleicht so, dass in jeder Gruppe gleich viele Werte sind?
...
Hier folgen einige gebräuchliche Täuschungsmanöver.
