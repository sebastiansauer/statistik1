...
[Die YouTube-Sammlung "Datenjudo"](https://www.youtube.com/playlist?list=PLRR4REmBgpIGet_lcNf2wOd0W8j4c9hYN) gibt einen Überblick über typische Tätigkeiten des Datenjudo mit R.
...
etwa mittels der Plattform [partici.fy](https://partici.fi/30134458).
...
#| out-width: "75%"
#| fig-align: center
qr <- qrcode::qr_code("https://partici.fi/30134458")
plot(qr)
```
:::
::::
