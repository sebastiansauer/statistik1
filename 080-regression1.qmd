...
Sind die Residuen im Schnitt groß, so ist die Modellgüte gering (schlecht), und umgekerht.
Verschiedenen Koeffizienten stehen zur Verfügung: R-Quadrat, r^[als Korrelation von tatsächlichem $y$ und vorhergesaten $\hat{y}], MSE, RMSE, MAE, ...
