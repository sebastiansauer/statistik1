...
Kurz, Sie brauchen Hilfe von einem kundigen Menschen?^[<https://www.youtube.com/watch?v=2Q_ZzBGPdqE>]
...
Also: Sie müssen Ihr Problem nachvollziehbar aber möglichst prägnant formulieren. 
...
`data_read()` (aus dem Meta-Paket `{easystats}`) ist praktisch, da es viele verschiedenen Datenformate lesen kann und selbständig erkennt, 
um welches Datenformat (CSV, XLSX,...) es sich handelt.
...
Praktischerweise wird das Zertifikat gleich Ihrem Profil zugeordnet.$\square$
:::
